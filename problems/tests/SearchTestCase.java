...
public class SearchTestCase implements TestCase {
	...
	public SearchTestCase(Object[] testParameters, int index) {
	...
	public Object[] getTest() {
		return new Object[]{ ((Integer[])test[0]).clone(), ((Integer) test[1]), ((Integer) test[2])};
	}
